...
The agency should specify that the contractor and any tier of subcontractor will afford the agency, any Office of Inspector General, or Department of Justice access to the contractor’s facilities, installations, operations, documentation, databases, IT systems, devices, and personnel used in performance of the contract, regardless of location.  Access shall be provided to the extent required to conduct an inspection, evaluation, investigation or audit and to preserve evidence of information security incidents regardless of whether Government information is commingled with other non-Government information on the relevant systems, devices, databases, etc.. Finally, agencies should include contract language requiring that, prior to contract closeout, the contractor must:
